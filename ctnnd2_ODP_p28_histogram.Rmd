...
p28_BZ_width <- read.csv("BZ_width_histogram_p28.csv")
p28_BZ_width <- p28_BZ_width
p28_BZ_width <- p28_BZ_width[!is.na(p28_BZ_width$Length) & p28_BZ_width$Length > 60,]
...
p28_BZ_width <- data.frame(animal = p28_BZ_width$Animal,
                     genotype = p28_BZ_width$Genotype,
                     sex = p28_BZ_width$Sex,
                     condition = p28_BZ_width$Condition,
                     width = p28_BZ_width$Length) 
                     #quality = p28_BZ_width$Quality)
...
ppi = 300
superplot_p28
ggsave(filename = "ctnnd2_ko_v_ctrl_superplot_p28_histogram_method.png", width = 5, height = 3)
...
ppi = 300
superplot_p28
ggsave(filename = "ctnnd2_ko_v_ctrl_superplot_normalized_p28_histogram_method.png", width = 5, height = 3)
